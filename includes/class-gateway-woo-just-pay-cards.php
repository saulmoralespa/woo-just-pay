...
class WC_Payment_Woo_Just_Pay_Cards_SMP extends WC_Payment_Gateway
{
    public function __construct()
    {
        $shop_currency = get_option('woocommerce_currency');

        $this->id = 'woo_just_pay_cards_smp';
        $this->icon = woo_just_pay_smp()->plugin_url . "assets/images/cards-$shop_currency.png";
        $this->method_title = __('Just Pay Credit and debit cards', 'woo-just-pay');
        $this->method_description = __('Just Pay Credit and debit cards payment method', 'woo-just-pay');
    ...
    public function is_available()
    {
        ...
        return parent::is_available() &&
            $just_pay->is_available() &&
            in_array($shop_currency, ['CLP']);
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            'enabled' => [
                ...
                'type' => 'checkbox',
                'label' => __('Just Pay Credit and debit cards', 'woo-just-pay'),
                'default' => 'no'
            ],
            'title' => [
                ...
                'default' => __('Just Pay Credit and debit cards', 'woo-just-pay'),
                'desc_tip' => true
            ],
            'description' => [
                ...
                'default' => __('Just Pay Credit and debit cards', 'Just Pay Cash'),
                'desc_tip' => true
            ],
